...
const projects = [
  {
    ...
    imageUrl: `${import.meta.env.BASE_URL}images/projects/foundation-1.jpg`,
    location: 'Dessie',
    date: 'In Progress 2024',
    type: 'Commercial',
    details: 'Multi-story commercial space with reinforced concrete structure',
  },
  {
    ...
    imageUrl: `${import.meta.env.BASE_URL}images/projects/foundation-2.jpg`,
    location: 'Gerba',
    date: 'In Progress 2024',
    type: 'Commercial',
    details: 'Advanced foundation work with steel reinforcement',
  },
  {
    ...
    imageUrl: `${import.meta.env.BASE_URL}images/projects/foundation-3.jpg`,
    location: 'Dessie',
    date: 'In Progress 2024',
    type: 'Commercial',
    details: 'Strategic location with mountain backdrop',
  },
  {
            ...
            >
              <div className="relative w-full">
                <img
                  ...
                  alt={project.title}
                  className="aspect-[16/9] w-full rounded-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2] border-2 border-primary-600"
                />
